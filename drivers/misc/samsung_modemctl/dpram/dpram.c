...
#ifdef CONFIG_MACH_HTCATHENA
#define GPIO_AP_RXD					1 // to be defined
#define GPIO_AP_RXD_AF				0x2 // UART_2_RXD

#define GPIO_AP_TXD					1 // to be defined
#define GPIO_AP_TXD_AF				0x2 // UART_2_TXD

#define GPIO_PHONE_ON				1 // to be defined
#define GPIO_PHONE_ON_AF			0x1

#define GPIO_PHONE_RST_N				GPIO50_HTCATHENA_DPR_RESET5 // to be defined
#define GPIO_PHONE_RST_N_AF				0x1

#define GPIO_PDA_ACTIVE				1 // to be defined
#define GPIO_PDA_ACTIVE_AF			0x1

#define GPIO_PHONE_ACTIVE			1 // to be defined
#define GPIO_PHONE_ACTIVE_AF		0xff	

#define GPIO_ONEDRAM_INT_N		GPIO51_HTCATHENA_DPR_IRQ_AT  // to be defined
#define GPIO_ONEDRAM_INT_N_AF	0xff

#define IRQ_ONEDRAM_INT_N		PXA_GPIO_TO_IRQ(GPIO51_HTCATHENA_DPR_IRQ_AT)  // to be defined
#define IRQ_PHONE_ACTIVE		1 // to be defined

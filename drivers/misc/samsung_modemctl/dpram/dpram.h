...
#define DPRAM_START_ADDRESS_PHYS 		0x10000000// Athena previous 0x30000000
#define DPRAM_SHARED_BANK				0 			// Athena previous 0x5000000

#define DPRAM_SHARED_BANK_SIZE		    0x1000  //    Athena  preevious 0x1000000

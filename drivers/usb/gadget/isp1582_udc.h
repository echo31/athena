...
#define ISP1582_ADDR_REG	REG_SIZE*0X00
#define ISP1582_MODE_REG	REG_SIZE*0X0C
#define ISP1582_INTCONF_REG	REG_SIZE*0X10
#define ISP1582_OTG_REG		REG_SIZE*0X12
#define ISP1582_INTEN_L_REG	REG_SIZE*0X14
#define ISP1582_INTEN_M_REG	REG_SIZE*0X16

#define ISP1582_EPINDEX_REG	REG_SIZE*0X2C
#define ISP1582_EPCFG_REG	REG_SIZE*0X28
#define ISP1582_EPDATA_REG	REG_SIZE*0X20
#define ISP1582_BUFFLEN_REG	REG_SIZE*0X1C
#define ISP1582_BUFFST_REG	REG_SIZE*0X1E
#define ISP1582_MAXPKT_REG	REG_SIZE*0X04
#define ISP1582_EPTYPE_REG	REG_SIZE*0X08

#define ISP1582_DMACMD_REG	REG_SIZE*0X30
#define ISP1582_DMACNT_L_REG	REG_SIZE*0X34
#define ISP1582_DMACNT_H_REG	REG_SIZE*0X36
#define ISP1582_DMACFG_REG	REG_SIZE*0X38
#define ISP1582_DMAHW_REG	REG_SIZE*0X3C
#define ISP1582_DMATASK_REG	REG_SIZE*0X40
#define ISP1582_DMAINTS_REG	REG_SIZE*0X50
#define ISP1582_DMAINTEN_REG	REG_SIZE*0X54
#define ISP1582_DMAEP_REG	REG_SIZE*0X58
#define ISP1582_DMASTROBETM_REG	REG_SIZE*0X60
#define ISP1582_DMABSTCNT_REG	REG_SIZE*0X64

#define ISP1582_INTS_L_REG	REG_SIZE*0X18
#define ISP1582_INTS_M_REG	REG_SIZE*0X1A
#define ISP1582_CHIPID_L_REG	REG_SIZE*0X70
#define ISP1582_CHIPID_M_REG	REG_SIZE*0X72
#define ISP1582_FRAMENUM_REG	REG_SIZE*0X74
#define ISP1582_SCRATCH_REG	REG_SIZE*0X78
#define ISP1582_UNLOCK_REG	REG_SIZE*0X7C
#define ISP1582_TESTMODE_REG	REG_SIZE*0X84
